...
void CompleteImageExample(MIL_ID MilSystem, MIL_ID MilDisplay)
   ...
   if(Value==1)
      ...
      FixtureOffset = McalAlloc(MilSystem, M_FIXTURING_OFFSET, M_DEFAULT, M_NULL);
      McalFixture(MilImage, FixtureOffset, M_MOVE_RELATIVE, M_RESULT_MOD, MilModelFinderResult, 0, M_DEFAULT, M_DEFAULT, M_DEFAULT);

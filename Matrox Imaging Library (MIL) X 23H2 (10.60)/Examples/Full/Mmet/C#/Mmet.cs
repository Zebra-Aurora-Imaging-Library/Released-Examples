...
namespace MMet
{
    class Program
    {
        ...
        static void SimpleImageExample(MIL_ID MilSystem, MIL_ID MilDisplay)
        {
            ...
            double Status = 0.0;
            double Value = 0.0;
            MIL_INT[] FeatureIndexForTopConstructedPoint = new MIL_INT[1];
            FeatureIndexForTopConstructedPoint[0] = MIL.M_FEATURE_INDEX(1);
            MIL_INT[] FeatureIndexForMiddleConstructedPoint = new MIL_INT[1];
            FeatureIndexForMiddleConstructedPoint [0] = MIL.M_FEATURE_INDEX(2);
            ...
            MIL.MmetAddFeature(MilMetrolContext, MIL.M_CONSTRUCTED, MIL.M_POINT, MIL.M_DEFAULT,
                           MIL.M_CENTER, FeatureIndexForTopConstructedPoint, MIL.M_NULL, 1, MIL.M_DEFAULT);

            // Add a second constructed point feature to context
            MIL.MmetAddFeature(MilMetrolContext, MIL.M_CONSTRUCTED, MIL.M_POINT, MIL.M_DEFAULT,
                           MIL.M_CENTER, FeatureIndexForMiddleConstructedPoint, MIL.M_NULL, 1, MIL.M_DEFAULT);
        ...
        static void CompleteImageExample(MIL_ID MilSystem, MIL_ID MilDisplay)
        {
            ...
            MIL_ID FixtureOffset = MIL.M_NULL;                   // Fixture offset
            ...
            MIL.MmetAddFeature(MilMetrolContext, MIL.M_MEASURED, MIL.M_SEGMENT, SEGMENT2_LABEL,
                           MIL.M_INNER_FIT, MIL.M_NULL, MIL.M_NULL, 0, MIL.M_DEFAULT);
            ...
            if (Value == 1)
            {
                ...
                FixtureOffset = MIL.McalAlloc(MilSystem, MIL.M_FIXTURING_OFFSET, MIL.M_DEFAULT, MIL.M_NULL);
                MIL.McalFixture(MilImage, FixtureOffset, MIL.M_MOVE_RELATIVE, MIL.M_RESULT_MOD, MilModelFinderResult, 0, MIL.M_DEFAULT, MIL.M_DEFAULT, MIL.M_DEFAULT);

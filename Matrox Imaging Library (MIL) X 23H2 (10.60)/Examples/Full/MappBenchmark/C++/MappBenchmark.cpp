...
int MosMain(void)
   ...
   MIL_INT    NbPerformanceLevel;      /* Number of performance level. */
   ...
   MappInquireMp(MilSystemOwnerApplication, M_MP_NB_PERFORMANCE_LEVEL, M_DEFAULT, M_DEFAULT, &NbPerformanceLevel);
   ...
   for(CurrentMaxPerfLevel = NbPerformanceLevel; CurrentMaxPerfLevel > 0; CurrentMaxPerfLevel--)
      ...
      */
      ...
      MappControlMp(MilSystemOwnerApplication, M_MP_USE_PERFORMANCE_LEVEL, CurrentMaxPerfLevel, M_DISABLE, M_NULL);

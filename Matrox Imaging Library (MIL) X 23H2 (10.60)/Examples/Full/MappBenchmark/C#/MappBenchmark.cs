...
namespace MAppBenchmark
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            MIL_INT NbPerformanceLevel = 0;                 // Number of performance level.
            MIL_INT CurrentMaxPerfLevel = 0;
            ...
            MIL.MappInquireMp(MilSystemOwnerApplication, MIL.M_MP_NB_PERFORMANCE_LEVEL, MIL.M_DEFAULT, MIL.M_DEFAULT, ref NbPerformanceLevel);

...
namespace MgraText
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MIL.MgraFont(MilGraphicContextId, MIL.M_FONT_DEFAULT_TTF);
            ...
            if (MIL.MappGetError(MIL.M_DEFAULT, MIL.M_GLOBAL + MIL.M_SYNCHRONOUS, MIL.M_NULL) != MIL.M_NULL_ERROR)
            {

...
int MosMain(void)
{
   ...
   MgraFont(MilGraphicContextId, 
               M_FONT_DEFAULT_TTF MIL_TEXT(":Bold:Italic"));
   ...
   // Note: Distributed MIL supports clusters of Linux and Windows PCs
   //       so the remote PC could be running a different operating system
   MIL_ID OwnerApplication = M_NULL;

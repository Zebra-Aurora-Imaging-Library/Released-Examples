...
public:
   ...
   bool IsGDIAnnotationsEnabled(){return m_isGDIAnnotationsEnabled;}
...
protected:
   ...
   afx_msg void OnGDIAnnotations();
   afx_msg void OnUpdateGDIAnnotations(CCmdUI* pCmdUI);
   ...
   afx_msg void OnGraOpacity(UINT nID);
   afx_msg void OnUpdateGraOpacity(CCmdUI *pCmdUI);
   afx_msg void OnOverlayOpacity(UINT nID);
   afx_msg void OnUpdateOverlayOpacity(CCmdUI *pCmdUI);
   ...
   afx_msg void OnGraDrawDirCycle();
   afx_msg void OnUpdateGraDrawDirCycle(CCmdUI *pCmdUI);
   afx_msg void OnGraDrawOrientedRect();
   afx_msg void OnUpdateGraDrawOrientedRect(CCmdUI *pCmdUI);
   afx_msg void OnGraDrawThreePointsArc();
   afx_msg void OnUpdateGraDrawThreePointsArc(CCmdUI *pCmdUI);
   afx_msg void OnGraLineThicknessToggle();
   afx_msg void OnUpdateGraLineThicknessToggle(CCmdUI *pCmdUI);
...
private:
   ...
   MIL_INT     m_currentGraOpacity;             //Current Opacity setting (M_GRAPHIC_LIST_OPACITY dispControl)
   MIL_INT     m_currentOverlayOpacity;         //Current Opacity setting (M_OVERLAY_OPACITY dispControl)
   ...
   bool        m_isGDIAnnotationsEnabled;       //GDI Annotations state
   ...
   static const UINT s_FirstOverlayOpacityControlInRange;
   static const UINT s_FirstGraOpacityControlInRange;
   static const MIL_INT s_QFactor[];
   static const MIL_INT s_Opacity[];
};

...
def MimHistogramExample():
   ...
   AnnotationColor = MIL.M_COLOR_RED
   ...
   HistResult = MIL.MimAllocResult(MilSystem, HIST_NUM_INTENSITIES, MIL.M_HIST_LIST)
   
   # Calculate the histogram.
   MIL.MimHistogram(MilImage, HistResult)
   
   # Get the results.
   HistValues = MIL.MimGetResult(HistResult, MIL.M_VALUE)
   ...
   MIL.MgraLines(MIL.M_DEFAULT, MilOverlayImage, HIST_NUM_INTENSITIES, 
                        XStart, YStart, XEnd, YEnd, MIL.M_DEFAULT)

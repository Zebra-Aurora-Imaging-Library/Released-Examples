//***************************************************************************************
// 
// File name: CapScrewInspection_CapAndContent.cpp
//
...
// Constructor.
//*****************************************************************************
CCapScrewInspection::CCapScrewInspection(MIL_CONST_TEXT_PTR MeasContextPath, 
                                         MIL_DOUBLE PositionYTolerance, 
                                         MIL_DOUBLE AngleTolerance, 
...
void CCapScrewInspection::DrawTextResult(MIL_ID MilGraContext, MIL_ID MilDest)
   ...
   if(GetResultStatus() ==  eUnknown)
      ...
      MgraText(MilGraContext, MilDest, 0, 0, MIL_TEXT("Cap screw: UNKNOWN"));
      }
   else
      {

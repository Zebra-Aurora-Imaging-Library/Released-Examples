//***************************************************************************************
// 
// File name: defectdetectionprocfunc_CapAndContent.cpp
//
...
MIL_INT ExtractDefects(MIL_ID MilDifferenceGrayImage,
   ...
   // Draw the blobs in the image.
   MbufClear(MilExtractedDefectsImage, 0);
   MgraColor(M_DEFAULT, 255);
   MblobDraw(M_DEFAULT, MilBlobResult, MilExtractedDefectsImage, M_DRAW_BLOBS, M_DEFAULT, M_DEFAULT);
...
void ExtractDifferences(MIL_ID MilTemplateImage,
   ...
   // Subtract the gradient mask to prevent edge effect.

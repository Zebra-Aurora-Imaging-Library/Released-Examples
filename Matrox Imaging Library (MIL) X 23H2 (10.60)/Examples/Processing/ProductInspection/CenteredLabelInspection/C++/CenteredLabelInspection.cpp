...
int MosMain(void)
   ...
   CLidIdentification      Prod0BananaPattern           (PRODUCT0_PATH MIL_TEXT("BananaPattern.mpat"), M_RGB_TO_L, &Prod0BananaMetAndAlignment);
   ...
   CLidIdentification      Prod0StrawberryPattern           (PRODUCT0_PATH MIL_TEXT("StrawberryPattern.mpat"), M_RGB_TO_L, &Prod0StrawberryMetAndAlignment);
   ...
   CLidIdentification      Prod0BlueberryPattern         (PRODUCT0_PATH MIL_TEXT("BlueberryPattern.mpat"), M_RGB_TO_L, &Prod0BlueberryMetAndAlignment);

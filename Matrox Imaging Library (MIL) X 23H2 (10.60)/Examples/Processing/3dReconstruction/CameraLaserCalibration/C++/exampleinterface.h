...
class CExampleInterface
   ...
   public:
      ...
      virtual void    PrintExplanationForMinContrast() const = 0;

      virtual bool    AskMinContrastAdjust(MIL_INT* pMinContrast) = 0;
      ...
      virtual MIL_ID  TryToReloadCameraCalibration(MIL_CONST_TEXT_PTR CalibrationFileName) const = 0;

      virtual void    GrabCalibrationGrid() = 0;
      virtual void    GrabLaserLineToAdjustContrast() = 0;

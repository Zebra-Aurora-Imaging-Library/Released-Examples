...
//*****************************************************************************
// Adjust M_MINIMUM_CONTRAST value when user use (1,2,4,5).
//*****************************************************************************
bool CInteractiveExample::AskMinContrastAdjust(MIL_INT* pMinContrast)
   ...
   while (MosKbhit())
      ...
      // Bring back M_MINIMUM_CONTRAST in the range [0,255]
      if (*pMinContrast < 0)
         *pMinContrast = 0;
...
//*****************************************************************************
MIL_ID CInteractiveExample::TryToReloadCameraCalibration(MIL_CONST_TEXT_PTR CalibrationFileName) const
   {
...
bool CInteractiveExample::GrabCalibrationLaserLine(MIL_INT ReferencePlaneIndex, MIL_DOUBLE CalibrationDepth, bool ShouldAskIfFinished)
   ...
   if (ShouldAskIfFinished && (UserChar == MIL_TEXT('s') || UserChar == MIL_TEXT('S')))
      {
...
// Prompts user for yes/no
//*****************************************************************************
bool CInteractiveExample::AskYesNo(MIL_CONST_TEXT_PTR QuestionString)
   {

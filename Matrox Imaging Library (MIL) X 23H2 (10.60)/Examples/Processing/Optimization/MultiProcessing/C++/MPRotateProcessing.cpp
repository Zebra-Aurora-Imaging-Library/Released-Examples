...
static MIL_CONST_TEXT_PTR const ROTATE_PROCESSING_IMAGE = EXAMPLE_IMAGE_PATH MIL_TEXT("LargeWafer.mim");
static const MIL_DOUBLE           ROTATION_INCREMENT      = 8.0;

//*****************************************************************************
// Constructor. 
//*****************************************************************************
CMPRotateProcessing::CMPRotateProcessing(MIL_CONST_TEXT_PTR Title, MIL_INT ProcessingIndex)
: CMPProcessing(Title,

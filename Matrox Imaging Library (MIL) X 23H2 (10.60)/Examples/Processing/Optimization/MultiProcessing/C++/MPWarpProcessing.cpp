...
static MIL_CONST_TEXT_PTR const   WARP_PROCESSING_IMAGE = EXAMPLE_IMAGE_PATH MIL_TEXT("LargeWafer.mim");
...
// Constructor. 
//*****************************************************************************
CMPWarpProcessing::CMPWarpProcessing(MIL_CONST_TEXT_PTR Title, MIL_INT ProcessingIndex)
: CMPProcessing(Title,

/**********************************************************************************/
/*
 *  File name: DMILObjectTracking.cpp
 *
 ...
 *
 *             The slave function can be found in the DMILObjectTrackingSlave project.
 *
 ...
 *        autonomously on the Target system without sending every MIL
 *        command individually from the Host computer. This has the great 

...
MIL_CONST_TEXT_PTR ROBOT_IP = MIL_TEXT("127.0.0.1:2001"); /* NEED TO BE CHANGED */
...
int MosMain(void)
{
   ...
   McomAlloc(MilSystem, M_COM_PROTOCOL_EPSON, ROBOT_IP, M_DEFAULT, M_DEFAULT, &MilCom);
